...
from ushare.core.hooks import packages_installed
from ushare.core.utils import abrevia
from ushare.core.utils import abreviaPlainText
...
class GridEventsView(FolderView):
    ...
    def get_events(self):
        ...
        if 'ushare.miranza' in installed:
            from ushare.miranza.patches import get_events as get_events_miranza
